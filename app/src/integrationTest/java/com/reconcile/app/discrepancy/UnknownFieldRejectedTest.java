...
@Testcontainers
@TenantTest
@DisplayName("UnknownFieldRejected — a stray unknown JSON property is rejected with 400")
class UnknownFieldRejectedTest {
    ...
    @Test
    @DisplayName("body with a stray 'source' field → 400, not silently ignored")
    void strayFieldRejected(TenantId tenantId) throws Exception {
