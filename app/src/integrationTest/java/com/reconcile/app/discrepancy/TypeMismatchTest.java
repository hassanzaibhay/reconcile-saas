...
@Testcontainers
@TenantTest
@DisplayName("TypeMismatch — a cluster-shaped body against an UNMATCHED discrepancy is rejected")
class TypeMismatchTest {
    ...
    @Test
    @DisplayName("UNMATCHED discrepancy + non-empty pairings → 422")
    void clusterBodyAgainstUnmatchedDiscrepancyRejected(TenantId tenantId) throws Exception {
        ...
        Map<String, Object> body = Map.of(
                "pairings",
                List.of(Map.of("a", UUID.randomUUID(), "b", UUID.randomUUID())),
                "leftUnmatched",
                List.of());
